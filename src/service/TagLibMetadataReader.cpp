...
std::map<std::string, std::string> TagLibMetadataReader::extractTags(const std::string &filepath,
...
{
    static const std::vector<std::string> supportedFormats = {".mp3", ".flac", ".ogg", ".m4a", ".wav", ".wma", ".ape"};
