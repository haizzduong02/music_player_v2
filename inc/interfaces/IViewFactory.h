...
class IViewFactory
{
  public:
     ...
     */
    virtual IView *createLibraryView(LibraryController *controller, Library *library,
     ...
     */
    virtual IView *createPlaylistView(PlaylistController *controller, PlaylistManager *manager,
     ...
     */
    virtual IView *createNowPlayingView(PlaybackController *controller, PlaybackState *state) = 0;
     ...
     */
    virtual IView *createHistoryView(HistoryController *controller, History *history,
                                     PlaybackController *playbackController, PlaylistManager *playlistManager) = 0;
     ...
     */
    virtual IView *createFileBrowserView(IFileSystem *fileSystem, LibraryController *libController) = 0;
};
