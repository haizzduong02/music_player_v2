...
class MediaFileFactory
{
  public:
     ...
     */
    static std::unique_ptr<MediaFile> createMediaFile(const std::string &filepath,
     ...
     * @return Unique pointer to MediaFile
     */
    static std::unique_ptr<MediaFile> createMediaFileWithMetadata(const std::string &filepath,
