...
class ViewFactory : public IViewFactory
{
  public:
     ...
     */
    IView *createLibraryView(LibraryController *controller, Library *library, PlaybackController *playbackController,
     ...
     */
    IView *createPlaylistView(PlaylistController *controller, PlaylistManager *manager,
     ...
     */
    IView *createNowPlayingView(PlaybackController *controller, PlaybackState *state) override;
     ...
     */
    IView *createHistoryView(HistoryController *controller, History *history, PlaybackController *playbackController,
     ...
     */
    IView *createFileBrowserView(IFileSystem *fileSystem, LibraryController *libController) override;
};
