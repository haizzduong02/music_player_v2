...
class MainWindow : public BaseView
{
  public:
    ...
    void setNowPlayingView(NowPlayingView *view)
    {
        nowPlayingView_ = view;
    }
    void setHistoryView(HistoryView *view)
    {
        historyView_ = view;
    }
    void setFileBrowserView(FileBrowserView *view)
    {
        fileBrowserView_ = view;
    }
    ...
    FileBrowserView *getFileBrowserView() const
    {
        return fileBrowserView_;
    }
    PlaylistView *getPlaylistView() const
    {
        return playlistView_;
    }
    NowPlayingView *getNowPlayingView() const
    {
        return nowPlayingView_;
    }
