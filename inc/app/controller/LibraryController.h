...
class LibraryController : public ITrackListController
{
  public:
     ...
     */
    LibraryController(Library *library, IFileSystem *fileSystem, IMetadataReader *metadataReader,
     ...
     */
    void setOnTrackRemovedCallback(std::function<void(const std::string &)> callback)
    {
        onTrackRemovedCallback_ = callback;
    }
